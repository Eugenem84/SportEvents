...
Команды бота (со слэшем и без):

| Команда | Что делает | Кому |
|---|---|---|
| `/games` («игры») | ближайшие игры, свободные места, кнопка записи на каждую | всем |
| `/my` («мои записи») | активные записи со статусом и кнопкой отмены | всем |
| `/cancel` («отмена»), кнопка «Пропускаю» | снять запись; первый из резерва едет в состав | всем |
| `/create` («создать игру») | игра и анонс в беседу; дата — из расписания, можно уточнить: «создать игру в среду 19:00» или «создать игру 27.09 19:00 8» | администратор беседы |
| `/settings` («настройки») | расписание игр: дни недели и время («вс 10:00», «убрать сб») | администратор беседы |
| `/help`, `/start` | список команд | всем |
| «подключить» | подключить беседу к боту | администратор беседы VK |
