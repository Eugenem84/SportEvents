...
* Запись одной кнопкой — готово: под полем ввода живут **[Иду] [Не иду]**, в чат уходит «3 - Евгений» / «3 - Евгений минус» / «3 - Пётр из резерва», человеку — персональная всплывашка (`messages.sendMessageEventAnswer`); повторное «Иду» и «Не иду» без записи в чат молчат
